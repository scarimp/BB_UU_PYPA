...
TestFromUnique.py	
------------------------------
Analizza i dieci campi presenti in AllUnique.csv
...
UniqueCodA.py		
------------------------------
Da: FileIn = 'RegDati/Out/ExtractA.csv'	A: FileOut = FileIn.replace("ExtractA.csv","ExtractUniCodA.csv")
...
UniqueCodB.py		
------------------------------
Da: FileIn = 'RegDati/Out/ExtractB.csv'	A: FileOut = FileIn.replace("ExtractB.csv","ExtractUniCodB.csv")
